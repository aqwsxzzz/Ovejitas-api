...
module.exports = {
	...
	async down(queryInterface) {
		// Recreate function to sync weight to animals table
		await queryInterface.sequelize.query(`
		...
		// Recreate trigger that fires after insert on animal_measurements
		await queryInterface.sequelize.query(`
		...
		// Recreate trigger that fires after update on animal_measurements
		await queryInterface.sequelize.query(`
